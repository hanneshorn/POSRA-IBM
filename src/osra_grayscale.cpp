...
bool convert_to_gray(Image &image, bool invert, bool adaptive, bool verbose, string debug_name)
{
  ...
  /*if(matte){
    image.matte(false);
    image.matteColor(ColorMono(true));
    image.write(debug_name + "inside_matte.gif");
  }*/

  //image.write(debug_name + "2Inside_Grayscale.gif");
  ...
  //image.write(debug_name + "3Inside_Grayscale.gif");
  ...
  //image.write(debug_name + "4Inside_Grayscale.gif");

  int window = min(image.columns(),image.rows()) / 41;
  if (window < 15) window = 15;

  // image.write(debug_name + "4halfInside_Grayscale.gif");
  // bryn debug
  // image.trim();
  // image.write(debug_name + "trimafter.gif");
  ...
  if (adaptive)
    ...
    {
      image.despeckle();
      //image.write(debug_name + "AfterDespeckle.gif");
      image = adaptive_otsu(image,window);
      //image.write(debug_name + "AfterAdOtsu.gif");
    }

  //image.write(debug_name + "5Inside_Grayscale.gif");
  ...
  //image.write(debug_name + "6Inside_Grayscale.gif");
