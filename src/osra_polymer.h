...
/* Polymer
 * General data structure to hold pertinent information, interfacing with the database.
*/
class Polymer {
      public:
      ...
      public:
            ...
            */
            ...
            void remove_brackets(Image &img){
                  ...
                  //change stroke width to like, 14 instead of 0.0
                  img.strokeWidth(0.0);
                  img.draw(DrawableRectangle(tlx, tly, brx, bry));
                  img.strokeColor("black");
                  // changed to like, 4 instead of 1.0
                  img.strokeWidth(1.0);
